...
export const projects: Project[] = [
  ...
  },
  {
    ...
    metrics: ['仕様駆動開発', 'QR管理', 'PWA', 'モバイルファースト'],
  ...
  },
  {
    ...
    metrics: ['仕様駆動開発', 'AI連携', 'WordPress連携', 'Docker Container Smoke Tests'],
  ...
  },
  {
    ...
    metrics: ['仕様駆動開発', 'SEO分析', '非同期ジョブ', 'Clean Architecture'],
